...
from routes import subjects, components, auth, dataTransfers, connection, widget, notifications , profile, categories , customTemplates
import os
import logging
...
app.include_router(customTemplates.router)
